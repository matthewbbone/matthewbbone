...
The structure of this model followed one of the models from the default Models Library that came with NetLogo called “Altruism”. You can read more about the model [here](http://ccl.northwestern.edu/rp/each/index.shtml)