---
title: "SFI's Introduction to Complexity"
date: "9/12/20"
---
...
<center>
<img src="complexitySci/TSPgrid.PNG" width="300">
</center>

Then I created a population of randomly generated possible routes that began and ended at city 0. Of course the random routes performed terribly with an average route distance of over 10,000 for a map of 20 cities in a 1000x1000 grid.  However, through some tweaking of the hyperparameters I was able to get a route of the distance 4279.89 which essentially makes a loop around the cities. The best route I could find by hand was 4258.93. The solution found by the genetic algorithm for the map above was:
...
<center>
[0, 17, 14, 10, 4, 11, 8, 18, 12, 16, 9, 7, 5, 13, 15, 19, 1, 3, 6, 2]
</center>
...
<center>
<img src="complexitySci/lacorona.PNG" width="300">
</center>
