...
<center>
```{r, echo=FALSE}
final_plot <- visNetwork(nodes, edges) %>%
...
saveWidget(frameableWidget(final_plot), file = "C:/Users/matth/Documents/codingProjects/Rstudio/matthewbbone/detect.html", selfcontained = TRUE)
